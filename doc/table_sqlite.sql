-- 删除备忘录
drop table if exists dt_memory;
-- 删除记事本
drop table if exists dt_note;
-- 删除待办事项表
...
INSERT INTO dt_category 
		VALUES (0, 0, '学习', 'study', '学习', 0, 0, '2015-12-12 21:40:40', '2015-12-14 22:11:18');
INSERT INTO dt_category 
