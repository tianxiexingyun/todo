...
<div class="breadcrumbs navbar-fixed-top">
	<ul class="breadcrumb">
		...
		<li class="active"><a href="javascript:load('${ctx}/user/list')">用户列表</a></li>
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-6 control-input">
				<input type="text" name="user.username" value="${user.username}" placeholder="用户名" class="form-control" required autofocus>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-6 control-input">
				<input type="text" name="user.nickname" value="${user.nickname}" placeholder="昵称"  class="form-control" required autofocus>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-3 control-label">备　注：</label> 
			<div class="col-md-6 control-input">
				<textarea 		  name="user.remark"   placeholder="备注" class="form-control" rows="2">${user.remark}</textarea>
			</div>
		</div>
