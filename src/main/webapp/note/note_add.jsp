...
<form class="form-horizontal" method="post" action="${ctx}/note/save" onsubmit="return doCKSubmit(this, addCatCallback);">
	<fieldset>
        <legend>新增记事信息</legend>
		<div class="clearfix form-group">
			<div class="col-md-offset-1 col-md-10">
				<input type="text" name="note.brief" placeholder="标题" class="form-control" required autofocus>
			</div>
		</div>
		<div class="clearfix form-group">
			<div class="col-md-offset-1 col-md-10">
				<textarea name="note.content" placeholder="内容" id="noteEditor" class="form-control" rows="12" required autofocus></textarea>
			</div>
		</div>
		<div class="clearfix form-group">
